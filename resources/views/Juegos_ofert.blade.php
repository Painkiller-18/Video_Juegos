...
<body>
<form action = "{{route('guarda_juego_of')}}" method = "POST">
    {{csrf_field()}}
    <!-- ============================================================== -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Juegos en Oferta:</h4>
                    </div>
                                    ...
                                    <label>ID de Oferta:
                                        ...
                                        <div class="input-group mb-1">
                                            <div class="input-group-prepend">
                                             ...
                                             <input type="text" value="{{$idsigue}}" name="id_of" id="id_of" class="form-control"  readonly="readonly" aria-label="Amount (to the nearest dollar)">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha_ini" id="fecha_ini" class="form-control" placeholder="">
                                    </div> 
                                    <div class="form-group">
                                        ...
                                        <input type="date"  name="fecha_fin" id="fecha_fin" class="form-control" placeholder="">
                                    </div>
                                    <!-- inicia radio-->
            <!-- ============================================================== -->
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <h3 class="font-weight-bold">Aviso de Privasidad</h3>
                                <div >
                                    <label> AL RELLENAR LA CASILLA CONFIRMO QUE HE LEÍDO, Y QUE ENTIENDO Y ACEPTO LOS TÉRMINOS Y CONDICIONES DEL PRESENTE 
                                    <a href="{{route('modal')}}"  method = "POST">
                                    AVISO DE PRIVACIDAD. </a>
                                    
                                    @if($errors->first('Aviso_priv'))
                                        <p class="text-danger">{{$errors->first('Aviso_priv')}}</ide>
                                        @endif
                                    </label>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="Aviso_priv" value="Aceptar" id="customCheck221">
                                            <label class="custom-control-label" for="customCheck221">Aceptar</label>
                                        </div>
                                    </div>
                                    <br>
